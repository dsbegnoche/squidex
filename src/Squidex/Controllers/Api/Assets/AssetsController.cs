    ...
    public sealed class AssetsController : ControllerBase
    {
        ...
        public async Task<IActionResult> GetAssets(string app, [FromQuery] string query = null, [FromQuery] string mimeTypes = null, [FromQuery] string ids = null, [FromQuery] int skip = 0, [FromQuery] int take = 10, [FromQuery] bool? imagesOnly = null)
        {
            ...
            var response = new AssetsDto
            {
                ...
                Items = taskForItems.Result.Select(x => SimpleMapper.Map(x, new AssetDto { FileType = x.FileExtension })).ToArray()
            };
        ...
        public async Task<IActionResult> GetAsset(string app, Guid id)
        {
            ...
            var response = SimpleMapper.Map(entity, new AssetDto { FileType = entity.FileExtension });
