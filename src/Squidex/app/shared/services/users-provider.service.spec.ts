...
describe('UsersProviderService', () => {
    ...
    it('should return users service when user not cached', () => {
        const user = new UserDto('123', 'mail@domain.com', 'User1', 'path/to/image', true, 'First1', 'Last1');
    ...
    it('should return me when user is current user', () => {
        ...
        expect(resultingUser).toEqual(new UserDto('123', 'mail@domain.com', 'Me', 'path/to/image', true, 'First1', 'Last1'));
    ...
    it('should return invalid user when not found', () => {
        ...
        expect(resultingUser).toEqual(new UserDto('NOT FOUND', 'NOT FOUND', 'NOT FOUND', null, false, 'NOT FOUND', 'NOT FOUND'));
