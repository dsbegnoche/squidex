    ...
    public class GraphQLTests
    {
        ...
        private readonly Schema schemaDef =
            Schema.Create("my-schema", new SchemaProperties())
                ...
                .AddOrUpdateField(new TagField(10, "my-tags", Partitioning.Invariant,
        ...
        public async Task Should_return_multiple_assets_when_querying_assets()
        {
            ...
            A.CallTo(() => assetRepository.QueryAsync(app.Id, null, null, "my-query", 30, 5, null))
                .Returns(assets);
        ...
        public async Task Should_also_fetch_referenced_assets_when_field_is_included_in_query()
        {
            ...
            A.CallTo(() => assetRepository.QueryAsync(app.Id, null, A<HashSet<Guid>>.That.Matches(x => x.Contains(assetRefId)), null, int.MaxValue, 0, null))
                .Returns(refAssets);
        ...
        private static IContentEntity CreateContent(Guid id, Guid refId, Guid assetId, NamedContentData data = null)
        {
            ...
            data = data ??
                new NamedContentData()
                    ...
                    .AddField("my-tags",
                        new ContentFieldData().AddValue("iv", JToken.FromObject(new[] { "value1", "value2" })));
